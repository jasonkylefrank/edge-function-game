  ...
  return (
    ...
    >
      <motion.div
        ...
        className="grid h-full grid-rows-[auto_1fr_auto] place-items-center bg-[#08eeb2] opacity-0"
      >
        ...
        <motion.div variants={otherElementsVariants}>
          <h4 className="mt-8 text-black/60">{"Network stats for nerds"}</h4>
          <p className="mt-4">{""}</p>
          {[1, 2, 3, 4].map((i) => (
            <p key={i} className="text-black/80">
              {"nerdy stat will be here..."}
            </p>
          ))}
          <p className="mb-8"></p>
        </motion.div>
